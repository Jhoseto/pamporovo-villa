        ...
        {AMENITIES.map((amenity, idx) => {
          ...
          return (
            <ScrollReveal key={amenity.title} delay={idx * 80}>
              <div className="group relative h-full overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-500 hover:-translate-y-2 hover:border-[var(--gold)]/30 hover:bg-white/10 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)]">
