...
export const VILLAS: Villa[] = [
  {
    ...
    description:
      "Топла и приветлива — с две спални, една баня и голяма всекидневна, в която камината пука, а на верандата ви чака барбекю. Любимата на семействата с деца.",
  ...
  },
  {
    ...
    description:
      "Светла и просторна, с две спални, една баня и всекидневна, отворена към планината. Верандата с барбекю е създадена за дълги вечери с приятели.",
  ...
  },
  {
    ...
    description:
      "Най-представителната от трите — със същия комфорт от две спални, една баня и голяма всекидневна, но с допълнително внимание към детайла и атмосферата. За тези, които искат нещо специално.",
...
export const VILLA_ABOUT = {
  ...
  layout:
    "Всяка вила е на две нива и разполага с две спални, една баня, напълно оборудвана кухня с трапезария и голяма всекидневна с камина на дърва. Отвън ви очакват тераса с панорама към Родопите и веранда с барбекю — мястото, където се раждат най-хубавите вечери.",
  hosts:
...
export const OFFERS: Offer[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      "Цяла вила: 2 спални, 1 баня, кухня и всекидневна",
