...
export const VILLA_PAGES_EN: Record<VillaId, VillaEnFields> = {
  "villa-1": {
    ...
    seoDescription:
      "Rent Villa 1 in Pamporovo — cosy family chalet, 2 bedrooms, 2 bathrooms, fireplace, BBQ, up to 6 guests. Raykovski Livadi, 2 km from pistes. Book online.",
    ...
    description:
      "Warm and welcoming — two bedrooms, two bathrooms, and a large living room where the fireplace crackles and BBQ awaits on the veranda. A favourite for families with children.",
  },
  "villa-2": {
    ...
    description:
      "Bright and spacious with two bedrooms, two bathrooms, and a living room open to the mountains. The BBQ veranda is made for long evenings with friends.",
  },
  "villa-deluxe": {
    ...
    description:
      "The most refined of the three — same comfort with two bedrooms, two bathrooms, and a large living room, but with extra attention to detail and atmosphere. For those who want something special.",
  },
};
